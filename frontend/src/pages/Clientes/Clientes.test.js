...
describe('Testes do Componente Clientes', () => {
  ...
  it('CT01: Deve renderizar a listagem de clientes retornados da API', async () => {
    ...
    mock.onGet('https://locatech-backend.onrender.com/clientes').reply(200, mockClientes);
  ...
  it('CT02: Deve permitir preencher o formulário e enviar um novo cadastro (POST)', async () => {
    mock.onGet('https://locatech-backend.onrender.com/clientes').reply(200, []);
    mock.onPost('https://locatech-backend.onrender.com/clientes').reply(201); // Simula criação
